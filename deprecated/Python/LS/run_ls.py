...
for k in range(mc_runs):
    ...
    X_star = ls.ls_solver(prob_params, data, X0=None, solver_params=None)
    ...
    X_est, norm_diff, norm_err, f_seq = dasf(prob_params, data, ls.ls_solver,
                                             conv, prob_eval=ls.ls_eval, solver_params=None, prob_select_sol=None)
...
plt.show()
plt.savefig("ls_convergence.pdf")

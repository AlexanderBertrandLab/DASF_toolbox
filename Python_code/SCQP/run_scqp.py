...
for k in range(mc_runs):
    ...
    X_star = scqp.scqp_solver(prob_params, data, X0=None, solver_params=None)
    ...
    X_est, norm_diff, norm_err, f_seq = dasf(prob_params, data, scqp.scqp_solver,
                                            conv, prob_eval=scqp.scqp_eval, solver_params=None, prob_select_sol=None)
...
plt.show()
plt.savefig("scqp_convergence.pdf")
